...
**Mechanisms:** Mech_Improved_Sheffet_RP, Mech_RP, Mech_Sheffet_RP  
**Task:** OLSFromRelease  
...
See [summary_table_20260407-181341.csv](summary_table_20260407-181341.csv) for the aggregate table.

### OLS Downstream Task

![OLS Downstream Utility Plot](ols_plot_eps_vs_mse_20260407-181341.png)

### Covariance Release Quality

![Covariance Release Quality Plot](covariance_plot_eps_vs_error_20260407-181341.png)

## Outputs

- Row-level results: `reports/bike_sharing_kaggle/demo_results.jsonl`
- Summary table: `summary_table_20260407-181341.csv`
- OLS figure: `ols_plot_eps_vs_mse_20260407-181341.png`
- Covariance figure: `covariance_plot_eps_vs_error_20260407-181341.png`
